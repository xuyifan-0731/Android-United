...
def detect_answer(question: str, model_answer: str, standard_answer: str, glm4_key: str):
    ...
    while call_time <= 5:
        call_time += 1
        return_message = get_completion(prompt=detect_prompt, glm4_key=glm4_key)
...
def get_completion(prompt, glm4_key):
